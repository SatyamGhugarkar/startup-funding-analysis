...
def load_investor_details(investor):
    ...
    with col1:
        ...
        #run above code after selecting data so use st.dataframe(big_series) then add below code
        fig, ax = plt.subplots()
        ax.bar(big_series.index, big_series.values)
        st.pyplot(fig)
    with col2:
        # check on which verticle he invest most amount
        ...
        st.pyplot(fig1)
    with col3:
        # check on which stage/round he invest most amount
